...
# Function to determine the free food given a dish order using if-else statements
def get_free_food(first_dish, second_dish):
  if first_dish == 'chicken' and second_dish == 'broccoli' or first_dish == 'broccoli' and second_dish == 'chicken':
    return 'ice cream'
  elif first_dish == 'steak' and second_dish == 'potato' or first_dish == 'potato' and second_dish == 'steak':
    return 'energy drink'
  elif first_dish == 'fish' and second_dish == 'rice' or first_dish == 'rice' and second_dish == 'fish':
    return 'cupcake'
  elif first_dish == 'turkey' and second_dish == 'salad' or first_dish == 'salad' and second_dish == 'turkey':
    return 'cheesecake'
  else:
    return 'cookie'


# Function to ask the user if they want to continue running the program
def continue_program():
  continue_choice = input(
    "\n\nWould you like to continue running the program? (yes/no): ")
...
# Main function
def main():
  continue_code = True  # Set the initial value to True

  while continue_code:  # Continue the loop while continue_code is True
    ...
    # Get the user's choice to continue or not
    continue_code = continue_program()
